...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='english:',bg="gray").grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='jw:',bg="gray").grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='su:',bg="gray").grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        ...
        self.txtHasil = Entry(mainFrame, width=50,bg="gray") 
        self.txtHasil.grid(row=2, column=1, padx=5, pady=5)

        self.txtHasil2 = Entry(mainFrame, width=50,bg="gray") 
        self.txtHasil2.grid(row=3, column=1, padx=5, pady=5)

        self.txtHasil3 = Entry(mainFrame, width=50,bg="gray") 
